...
package com.wenbao.flink.side.cache;
...
public class LRUSideCache extends AbsSideCache {
    ...
    public LRUSideCache(LRUCacheConfig lruCacheConfig) {
    ...
    public void initCache() {
        ...
        cache = CacheBuilder.newBuilder()
                .maximumSize(lruCacheConfig.getCacheSize())
                .expireAfterWrite(lruCacheConfig.getCacheTimeout(), TimeUnit.MILLISECONDS)
                .build();
    }
